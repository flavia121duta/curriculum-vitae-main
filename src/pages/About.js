...
export default function AboutPage() {
  ...
  const description = (
    <div className={classes.description}>
      <p>
        Hi! My name is Flavia, and I’m a recent graduate with a Master’s degree
        in
      ...
      <p>
        Beside my job as a data analyst, I have a strong passion for continuous
        learning and enjoy exploring new technologies or refining the ones I
        already know. Most of my projects so far have been developed either for
        university or as personal initiatives for myself and friends. I design
        the user interfaces of my applications myself. I have a solid foundation
        in{" "}
      ...
      <p>
        I'm currently open to new opportunities, whether it's in data analytics,
        software development, or UI/UX design. I’m especially interested in
        roles that allow me to combine these skills and contribute to
        meaningful, user-focused projects.
      </p>
    </div>
  );
